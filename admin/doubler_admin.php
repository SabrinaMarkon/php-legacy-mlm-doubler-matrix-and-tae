...
<tr><td align="center" colspan="2"><br>The downline you selected does not exist yet because you haven't yet enabled it.<br><br>If you would like to start another new downline, you can enable it <a href="doubler_settings.php">HERE</a></td></tr>
</table>
<?php
include "../footer.php";
exit;
...
echo "<p align=\"center\"><a href=\"doubler_admin.php?m=" . $matrixnumber . "\">Return</a></p>";
include "../footer.php";
exit;
} # if ($action == "newposition")
####################################################################################################
...
<tr><td align="center" colspan="2"><br>The ID you selected to delete positions for is no longer in the system (perhaps already deleted?).<br><br><a href="doubler_admin.php?m=<?php echo $matrixnumber ?>">Return</a></td></tr>
</table>
<?php
include "../footer.php";
exit;
...
<tr><td align="center" colspan="2"><br>The position you selected has been deleted.<br><br><a href="doubler_admin.php?m=<?php echo $matrixnumber ?>">Return</a></td></tr>
</table>
<?php
include "../footer.php";
exit;
...
<tr><td align="center" colspan="2"><br>You may now start this downline over again.<br><br><a href="doubler_admin.php?m=<?php echo $matrixnumber ?>">Return</a></td></tr>
</table>
<?php
include "../footer.php";
exit;
...
<tr><td align="center" colspan="2"><br><a href="doubler_admin.php?m=<?php echo $matrixnumber ?>">Return</a></td></tr>
</table>
<?php
include "../footer.php";
exit;
...
$targetpage = "doubler_admin.php"; 	# your file name  (the name of this file)
...
<tr><form action="doubler_admin.php" method="post"><td align="center" colspan="2"><br><br>
...
<form action="doubler_admin.php" method="post">

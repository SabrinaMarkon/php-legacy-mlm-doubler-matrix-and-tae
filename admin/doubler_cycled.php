...
echo "<p align=\"center\"><a href=\"doubler_cycled.php?m=" . $matrixnumber . "\">Return</a></p>";
include "../footer.php";
exit;
} # if ($action == "saveposition")
####################################################################################################
...
$targetpage = "doubler_cycled.php"; 	# your file name  (the name of this file)
...
?>
<form action="doubler_cycled.php" method="post">
...
{
?>
<form method="post" action="doubler_cycled.php">
<td align="center">

...
if($_POST['submit'] == "Delete")
{
	foreach($id as $each)
	{
	$delq = "delete from doubler_transactions where id='$each'";
...
$query = "select * from doubler_transactions order by dateadded desc";
...
<form action="doubler_transactions.php" method="post" name="transactions">

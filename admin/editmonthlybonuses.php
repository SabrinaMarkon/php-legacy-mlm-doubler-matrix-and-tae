...
<tr><td>Downline #1 Positions to add:</td><td><input type="text" name="doubler1_numsuperjv" value="<? echo $superjvbonuses['doubler1_num']; ?>"> Positions</td></tr>
<tr><td>Downline #2 Positions to add:</td><td><input type="text" name="doubler2_numsuperjv" value="<? echo $superjvbonuses['doubler2_num']; ?>"> Positions</td></tr>
<tr><td>Downline #3 Positions to add:</td><td><input type="text" name="doubler3_numsuperjv" value="<? echo $superjvbonuses['doubler3_num']; ?>"> Positions</td></tr>
<tr><td>Downline #4 Positions to add:</td><td><input type="text" name="doubler4_numsuperjv" value="<? echo $superjvbonuses['doubler4_num']; ?>"> Positions</td></tr>
<tr><td>Downline #5 Positions to add:</td><td><input type="text" name="doubler5_numsuperjv" value="<? echo $superjvbonuses['doubler5_num']; ?>"> Positions</td></tr>
<tr><td>Downline #6 Positions to add:</td><td><input type="text" name="doubler6_numsuperjv" value="<? echo $superjvbonuses['doubler6_num']; ?>"> Positions</td></tr>
<tr><td>Downline #7 Positions to add:</td><td><input type="text" name="doubler7_numsuperjv" value="<? echo $superjvbonuses['doubler7_num']; ?>"> Positions</td></tr>
<tr><td>Downline #8 Positions to add:</td><td><input type="text" name="doubler8_numsuperjv" value="<? echo $superjvbonuses['doubler8_num']; ?>"> Positions</td></tr>
<tr><td>Downline #9 Positions to add:</td><td><input type="text" name="doubler9_numsuperjv" value="<? echo $superjvbonuses['doubler9_num']; ?>"> Positions</td></tr>
<tr><td>Downline #10 Positions to add:</td><td><input type="text" name="doubler10_numsuperjv" value="<? echo $superjvbonuses['doubler10_num']; ?>"> Positions</td></tr>
...
<tr><td>Downline #1 Positions to add:</td><td><input type="text" name="doubler1_numjv" value="<? echo $jvbonuses['doubler1_num']; ?>"> Positions</td></tr>
<tr><td>Downline #2 Positions to add:</td><td><input type="text" name="doubler2_numjv" value="<? echo $jvbonuses['doubler2_num']; ?>"> Positions</td></tr>
<tr><td>Downline #3 Positions to add:</td><td><input type="text" name="doubler3_numjv" value="<? echo $jvbonuses['doubler3_num']; ?>"> Positions</td></tr>
<tr><td>Downline #4 Positions to add:</td><td><input type="text" name="doubler4_numjv" value="<? echo $jvbonuses['doubler4_num']; ?>"> Positions</td></tr>
<tr><td>Downline #5 Positions to add:</td><td><input type="text" name="doubler5_numjv" value="<? echo $jvbonuses['doubler5_num']; ?>"> Positions</td></tr>
<tr><td>Downline #6 Positions to add:</td><td><input type="text" name="doubler6_numjv" value="<? echo $jvbonuses['doubler6_num']; ?>"> Positions</td></tr>
<tr><td>Downline #7 Positions to add:</td><td><input type="text" name="doubler7_numjv" value="<? echo $jvbonuses['doubler7_num']; ?>"> Positions</td></tr>
<tr><td>Downline #8 Positions to add:</td><td><input type="text" name="doubler8_numjv" value="<? echo $jvbonuses['doubler8_num']; ?>"> Positions</td></tr>
<tr><td>Downline #9 Positions to add:</td><td><input type="text" name="doubler9_numjv" value="<? echo $jvbonuses['doubler9_num']; ?>"> Positions</td></tr>
<tr><td>Downline #10 Positions to add:</td><td><input type="text" name="doubler10_numjv" value="<? echo $jvbonuses['doubler10_num']; ?>"> Positions</td></tr>
...
<tr><td>Downline #1 Positions to add:</td><td><input type="text" name="doubler1_numpro" value="<? echo $probonuses['doubler1_num']; ?>"> Positions</td></tr>
<tr><td>Downline #2 Positions to add:</td><td><input type="text" name="doubler2_numpro" value="<? echo $probonuses['doubler2_num']; ?>"> Positions</td></tr>
<tr><td>Downline #3 Positions to add:</td><td><input type="text" name="doubler3_numpro" value="<? echo $probonuses['doubler3_num']; ?>"> Positions</td></tr>
<tr><td>Downline #4 Positions to add:</td><td><input type="text" name="doubler4_numpro" value="<? echo $probonuses['doubler4_num']; ?>"> Positions</td></tr>
<tr><td>Downline #5 Positions to add:</td><td><input type="text" name="doubler5_numpro" value="<? echo $probonuses['doubler5_num']; ?>"> Positions</td></tr>
<tr><td>Downline #6 Positions to add:</td><td><input type="text" name="doubler6_numpro" value="<? echo $probonuses['doubler6_num']; ?>"> Positions</td></tr>
<tr><td>Downline #7 Positions to add:</td><td><input type="text" name="doubler7_numpro" value="<? echo $probonuses['doubler7_num']; ?>"> Positions</td></tr>
<tr><td>Downline #8 Positions to add:</td><td><input type="text" name="doubler8_numpro" value="<? echo $probonuses['doubler8_num']; ?>"> Positions</td></tr>
<tr><td>Downline #9 Positions to add:</td><td><input type="text" name="doubler9_numpro" value="<? echo $probonuses['doubler9_num']; ?>"> Positions</td></tr>
<tr><td>Downline #10 Positions to add:</td><td><input type="text" name="doubler10_numpro" value="<? echo $probonuses['doubler10_num']; ?>"> Positions</td></tr>

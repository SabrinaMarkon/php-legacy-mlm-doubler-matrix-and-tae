...
<tr><td>Downline #1 Positions to add:</td><td><input type="text" name="doubler1_num" value="<? echo $oto['doubler1_num']; ?>"> Positions</td></tr>
<tr><td>Downline #2 Positions to add:</td><td><input type="text" name="doubler2_num" value="<? echo $oto['doubler2_num']; ?>"> Positions</td></tr>
<tr><td>Downline #3 Positions to add:</td><td><input type="text" name="doubler3_num" value="<? echo $oto['doubler3_num']; ?>"> Positions</td></tr>
<tr><td>Downline #4 Positions to add:</td><td><input type="text" name="doubler4_num" value="<? echo $oto['doubler4_num']; ?>"> Positions</td></tr>
<tr><td>Downline #5 Positions to add:</td><td><input type="text" name="doubler5_num" value="<? echo $oto['doubler5_num']; ?>"> Positions</td></tr>
<tr><td>Downline #6 Positions to add:</td><td><input type="text" name="doubler6_num" value="<? echo $oto['doubler6_num']; ?>"> Positions</td></tr>
<tr><td>Downline #7 Positions to add:</td><td><input type="text" name="doubler7_num" value="<? echo $oto['doubler7_num']; ?>"> Positions</td></tr>
<tr><td>Downline #8 Positions to add:</td><td><input type="text" name="doubler8_num" value="<? echo $oto['doubler8_num']; ?>"> Positions</td></tr>
<tr><td>Downline #9 Positions to add:</td><td><input type="text" name="doubler9_num" value="<? echo $oto['doubler9_num']; ?>"> Positions</td></tr>
<tr><td>Downline #10 Positions to add:</td><td><input type="text" name="doubler10_num" value="<? echo $oto['doubler10_num']; ?>"> Positions</td></tr>

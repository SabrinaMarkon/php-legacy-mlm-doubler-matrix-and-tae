...
$doubler1_num = mysql_result($mbr2,0,"doubler1_num");
$doubler2_num = mysql_result($mbr2,0,"doubler2_num");
$doubler3_num = mysql_result($mbr2,0,"doubler3_num");
$doubler4_num = mysql_result($mbr2,0,"doubler4_num");
$doubler5_num = mysql_result($mbr2,0,"doubler5_num");
$doubler6_num = mysql_result($mbr2,0,"doubler6_num");
$doubler7_num = mysql_result($mbr2,0,"doubler7_num");
$doubler8_num = mysql_result($mbr2,0,"doubler8_num");
$doubler9_num = mysql_result($mbr2,0,"doubler9_num");
$doubler10_num = mysql_result($mbr2,0,"doubler10_num");
...
$referid = "";
$userid = $mbuserid;
include "doubler_monthlybonus.php";
############################################

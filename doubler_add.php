...
$mrows1 = mysql_num_rows($mresult1);
	if ($mrows1 > 0)
		...
		elseif ($ref2 == 0)
			...
			$refq2 = "update matrix$matrixnumber set ref1='0',ref2='0',ref1username='',ref2username='',positionsleft=0,positionscycled=positionscycled+1,owed=owed+".$$payoutname.",done='yes',cycledate=NOW() where memberid='$refmemberid'";
...
$mrows11 = mysql_num_rows($mresult11);
	if ($mrows11 > 0)
		...
		elseif ($ref2 == 0)
			...
			$refr1 = mysql_query($refq1);
			# since all refs are filled now, the refmemberid has cycled a position.
			$refq21 = "update matrix$matrixnumber set ref1='0',ref2='0',ref1username='',ref2username='',positionsleft=0,positionscycled=positionscycled+1,owed=owed+".$$payoutname.",done='yes',cycledate=NOW() where memberid='$refmemberid'";

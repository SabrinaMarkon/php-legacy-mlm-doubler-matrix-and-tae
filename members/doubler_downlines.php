...
<input type="hidden" name="NOPAYMENT_URL" value="<?php echo $domain ?>/members/doubler_downlines.php">
...
<input type="hidden" name="ok_return_fail" value="<?php echo $domain ?>/members/doubler_downlines.php">
...
<input type="hidden" name="cancel_url"  value="<?php echo $domain ?>/members/doubler_downlines.php">
...
$targetpage = "doubler_downlines.php"; 	# your file name  (the name of this file)
...
<tr><td colspan="2"><br>The next top position will cycle (and be paid $<?php echo $$payoutname ?>!) per every 2 new positions!<br><br>The referrals shown for each person are towards their next position cycling. When a person's position cycles, they are removed from the top
<?php

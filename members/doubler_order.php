...
<tr><td align="center" colspan="2"><div class="heading">Order Downline Positions</div></td></tr>
<tr><td colspan="2"><br>
<div style="text-align: center;">
<?php
$query1 = "select * from pages where name='Member Order Page To Buy Positions'";
...
try {
	 ...
	 * Optional fields
	 */
	'fail_url'	=> $domain. '/members/doubler_order.php',
...
<input type="hidden" name="NOPAYMENT_URL" value="<?php echo $domain ?>/members/doubler_order.php">
...
<input type="hidden" name="ok_return_fail" value="<?php echo $domain ?>/members/doubler_order.php">
...
<input type="hidden" name="cancel_url"  value="<?php echo $domain ?>/members/doubler_order.php">

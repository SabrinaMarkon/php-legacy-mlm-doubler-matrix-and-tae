...
$doubler_button = "<center><table border=0 cellpadding=0 cellspacing=0 width=165 height=30><tr valign=middle><td align=\"center\" wrap style=\"background-image:url('$domain/images/button1.png')\" \"onMouseDown=\"this.style.backgroundImage='url($domain/images/button3.png)'\" onMouseOver=\"this.style.backgroundImage='url($domain/images/button3.png)'\"onMouseOut=\"this.style.backgroundImage='url($domain/images/button1.png)'\"><a href=\"~DOUBLER_BUTTON_URL~\" class=\"button\" onmouseover=\"window.status='~DOUBLER_BUTTON_TITLE~';return true\" onMouseOut=\"window.status='';return true\"><font color=\"#000000\">&nbsp;&nbsp;&nbsp;<font style=\"font-size: 10px;\">~DOUBLER_BUTTON_TITLE~</font>&nbsp;&nbsp;&nbsp;</font></a></td></tr></table>";
include "doubler_navigation.php";
##############################################################
